...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./GAUserRetentionWidget.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js!./GAUserRetentionWidget.scss");
...
;(function (w, d, s, g, js, fjs) {
  ...
  g.analytics = {
    ...
    ready: function ready(cb) {
      console.log('analytics start ready');
      this.q.push(cb);
    }
  };
  ...
  js.onload = function () {
    g.load("analytics", function () {
      console.log('onload analytics ready');
    });
    console.log('platform onload');
  };
  ...
  return {
    createComponent: function createComponent(React, Component) {
      return function (_Component) {
        _inherits(GAUserRetentionWidget, _Component);

        function GAUserRetentionWidget(props) {
          _classCallCheck(this, GAUserRetentionWidget);

          var _this = _possibleConstructorReturn(this, (GAUserRetentionWidget.__proto__ || Object.getPrototypeOf(GAUserRetentionWidget)).call(this, props));
          ...
          _this.loadAnalytics = function () {
            ...
            var attr = ['cohortNthDay', 'cohortNthWeek', 'cohortNthMonth'];

            var query1 = query({
              'ids': _this.state.view_id,
              'metrics': 'ga:cohortActiveUsers'
              // 'dimentions': `ga:cohort, ga:${attr[0]}`,
              // 'orderBys': 'ga:cohort',
              // 'cohortGroup': 'cohorts': [{ "name": "cohort 1", "type": "FIRST_VISIT_DATE", "dateRange": { "startDate": "2015-08-01", "endDate": "2015-08-01" } }],
            ...
            var query2 = query({
              'ids': _this.state.view_id,
              'metrics': 'ga:cohortActiveUsers',
              'dimentions': 'ga:cohort, ga:' + attr[1]
              // 'start-date': '30daysAgo',
              // 'end-date': 'yesterday',
            });
            ...
            var query3 = query({
              'ids': _this.state.view_id,
              'metrics': 'ga:cohortActiveUsers',
              'dimentions': 'ga:cohort, ga:' + attr[2]
              // 'start-date': '30daysAgo',
              // 'end-date': 'yesterday',
            });

            // Promise.all([query1, query2, query2]).then(function (results) {
            Promise.all([query1]).then(function (results) {
        ...
        _createClass(GAUserRetentionWidget, [{
